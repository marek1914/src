...
#  12/29/2015(MTA): changed default destination directory from            #
#  "/usr/local/include/digilent/adept" to "/usr/include/digilent/adept"   #
#                                                                         #
###########################################################################
...
incsrc="inc"
incdst="/usr/include/digilent/adept"
