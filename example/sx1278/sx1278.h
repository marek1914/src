...
const uint32_t CH_DEFAULT =
    0x6c8000;  // default channel, center frequency = 434.000MHz

// FREQUENCY CHANNELS (BANDWIDTH 500KHz):
const uint32_t CH_1_BW_500 = 0x6c5345;  // channel 1, bandwidth 500KHz, center
                                        // frequency = 433.3MHz ( 433.050MHz -
                                        // 433.550MHz )
const uint32_t CH_2_BW_500 = 0x6c7af3;  // channel 2, bandwidth 500KHz, center
                                        // frequency = 433.92MHz ( 433.670MHz -
                                        // 433.920MHz )
const uint32_t CH_3_BW_500 = 0x6ca2a1;  // channel 3, bandwidth 500KHz, center
                                        // frequency = 434.54MHz ( 434.290MHz -
                                        // 434.790MHz )

// FREQUENCY CHANNELS (BANDWIDTH 250KHz):
const uint32_t CH_1_BW_250 = 0x6c4b45;  // channel 1, bandwidth 250KHz, center
                                        // frequency = 433.175MHz ( 433.050MHz -
                                        // 433.300MHz )
const uint32_t CH_2_BW_250 = 0x6c5e57;  // channel 2, bandwidth 250KHz, center
                                        // frequency = 433.473MHz ( 433.348MHz -
                                        // 433.598MHz )
const uint32_t CH_3_BW_250 = 0x6c716a;  // channel 3, bandwidth 250KHz, center
                                        // frequency = 433.771MHz ( 433.646MHz -
                                        // 433.896MHz )
const uint32_t CH_4_BW_250 = 0x6c847c;  // channel 4, bandwidth 250KHz, center
                                        // frequency = 434.069MHz ( 433.944MHz -
                                        // 434.194MHz )
const uint32_t CH_5_BW_250 = 0x6c978f;  // channel 5, bandwidth 250KHz, center
                                        // frequency = 434.367MHz ( 434.242MHz -
                                        // 434.492MHz )
const uint32_t CH_6_BW_250 = 0x6caaa1;  // channel 6, bandwidth 250KHz, center
                                        // frequency = 434.665MHz ( 434.540MHz -
                                        // 434.790MHz )

// FREQUENCY CHANNELS (BANDWIDTH 125KHz):
const uint32_t CH_1_BW_125 = 0x6c4745;  // channel 1, bandwidth 125KHz, center
                                        // frequency = 433.1125MHz ( 433.050MHz
                                        // - 433.175MHz )
const uint32_t CH_2_BW_125 = 0x6c4fe1;  // channel 2, bandwidth 125KHz, center
                                        // frequency = 433.247MHz ( 433.1845MHz
                                        // - 433.3095MHz )
const uint32_t CH_3_BW_125 = 0x6c587c;  // channel 3, bandwidth 125KHz, center
                                        // frequency = 433.3815MHz ( 433.319MHz
                                        // - 433.444MHz )
const uint32_t CH_4_BW_125 = 0x6c6118;  // channel 4, bandwidth 125KHz, center
                                        // frequency = 433.516MHz ( 433.4535MHz
                                        // - 433.5785MHz )
const uint32_t CH_5_BW_125 = 0x6c69b3;  // channel 5, bandwidth 125KHz, center
                                        // frequency = 433.6505MHz ( 433.588MHz
                                        // - 433.713MHz )
const uint32_t CH_6_BW_125 = 0x6c724f;  // channel 6, bandwidth 125KHz, center
                                        // frequency = 433.785MHz ( 433.7225MHz
                                        // - 433.8475MHz )
const uint32_t CH_7_BW_125 = 0x6c7af3;  // channel 7, bandwidth 125KHz, center
                                        // frequency = 433.92MHz ( 433.8575MHz -
                                        // 433.9825MHz )
const uint32_t CH_8_BW_125 = 0x6c8397;  // channel 8, bandwidth 125KHz, center
                                        // frequency = 434.055MHz ( 433.9925MHz
                                        // - 434.1175MHz )
const uint32_t CH_9_BW_125 = 0x6c8c32;  // channel 9, bandwidth 125KHz, center
                                        // frequency = 434.1895MHz ( 434.127MHz
                                        // - 434.252MHz )
const uint32_t CH_10_BW_125 = 0x6c94ce;  // channel 10, bandwidth 125KHz, center
                                         // frequency = 434.324MHz ( 434.2615MHz
                                         // - 434.3865MHz )
const uint32_t CH_11_BW_125 = 0x6c9d6a;  // channel 11, bandwidth 125KHz, center
                                         // frequency = 434.4585MHz ( 434.396MHz
                                         // - 434.521MHz )
const uint32_t CH_12_BW_125 = 0x6ca605;  // channel 12, bandwidth 125KHz, center
                                         // frequency = 434.593MHz ( 434.5305MHz
                                         // - 434.6555MHz )
const uint32_t CH_13_BW_125 = 0x6CaeA1;  // channel 13, bandwidth 125KHz, center
                                         // frequency = 434.7275MHz ( 434.665MHz
                                         // - 434.790MHz )
