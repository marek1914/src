...
*---------------------------------------------------------------------------*/
void User_InitFlash(void);		//Flash初始化
void Example_MemCopy(Uint16 *SourceAddr, Uint16* SourceEndAddr, Uint16* DestAddr);
void User_FlashWrite(Uint16 *lpu16_buf, Uint16 lu16_Len);		//Flash写
Uint16 User_FlashRead(Uint16 *lpu16_buf, Uint16 lu16_Len);		//Flash读
